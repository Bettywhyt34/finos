...
const ROLES: Array<{ role: SystemAccountRole; label: string; description: string; types: AccountType[] }> = [
  ...
  { role: "ACCRUED_EXPENSES", label: "Accrued Expenses", description: "Costs recognised before the supplier Bill arrives. FINOS clears this liability when the later Bill is linked.", types: ["LIABILITY"] },
