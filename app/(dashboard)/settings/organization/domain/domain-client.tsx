...
export function DomainClient({ orgName }: Props) {
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="px-10 py-7 max-w-[880px] space-y-8">
            ...
            <div>
              <h1 className="text-xl font-semibold text-slate-900 tracking-tight">Custom Domain</h1>
            ...
            <section className="space-y-3">
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-sm text-slate-500 max-w-[360px]">
                  Custom domain support is not yet available. You&apos;ll be able to serve
                  your customer portal and invoice links from your own domain.
                </p>
              </div>
            </section>
