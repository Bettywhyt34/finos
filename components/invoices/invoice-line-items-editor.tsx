...
export function emptyLine(taxRates: TaxRateOption[]): LineItemData {
...
export function InvoiceLineItemsEditor({ currency, items, taxRates, lines, onChange }: Props) {
  ...
  function addLine() {
    onChange([...lines, emptyLine(taxRates)]);
  }
