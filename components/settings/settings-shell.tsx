...
export const SIDEBAR_NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      {
        id: "setup", label: "Setup & Configurations", icon: Sliders,
        children: [
          { id: "setup-general",           label: "General",          href: "/settings/setup-configurations/general"          },
          { id: "setup-currencies",        label: "Currencies",       href: "/settings/setup-configurations/currencies"       },
          { id: "setup-payment-terms",     label: "Payment Terms",    href: "/settings/setup-configurations/payment-terms"    },
          { id: "setup-opening-balances",  label: "Opening Balances", href: "/settings/setup-configurations/opening-balances" },
          { id: "setup-reminders",         label: "Reminders",        href: "/settings/setup-configurations/reminders"        },
          { id: "setup-customer-portal",   label: "Customer Portal",  href: "/settings/setup-configurations/customer-portal"  },
