...
const newDir = path.join(root, "app", "(dashboard)", "accounting", "fx-revaluation", "new");
...
fs.writeFileSync(path.join(newDir, "revaluation-form.tsx"), form);
console.log("Written: revaluation-form.tsx (v2)");
